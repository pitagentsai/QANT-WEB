    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto max-w-4xl space-y-12">
        <header className="space-y-2">
          ...
          <p className="text-muted-foreground">Documentation summary for product, architecture, and roadmap.</p>
        </header>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Executive Summary</h2>
          <p className="text-foreground/90">
            QUANT is a next-generation, quantum-resistant blockchain platform designed to secure digital assets against
            future quantum computing threats. It introduces a flexible privacy architecture allowing users to select between
            transparent, private, or accountable transaction modes. Built upon advanced post-quantum cryptography, QUANT
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-foreground/90">QUANT employs lattice-based primitives (Module-LWE and Module-SIS) to safeguard against quantum attacks that could compromise traditional cryptosystems like ECC or RSA.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-foreground/90">Selective Disclosure provides lawful traceability for designated authorities without sacrificing broad user anonymity.</p>
            </div>
            <div>
              <h3 className="text-lg font-medium">4. Provably Secure Architecture</h3>
              <p className="text-foreground/90">DAPOA (Decentralized Anonymous Payment with Optional Accountability) ensures mathematically sound privacy, anonymity, and accountability guarantees.</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-foreground/90">Initial Proof-of-Work (PoW) for decentralization, then a planned transition to Proof-of-Stake (PoS) for sustainability.</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-foreground/90">Transactions may embed a tracking public key for selective, auditable transparency.</p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Tokenomics</h2>
          <ul className="list-disc pl-6 text-foreground/90 space-y-1">
            <li><strong>Supply:</strong> Capped (e.g., 21M QNT)</li>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-foreground/90">
                <tr className="border-t border-border">
                  ...
                  <td className="py-2">QUANT Framework v1.0</td>
                </tr>
                <tr className="border-t border-border">
        ...
        <section className="space-y-4">
          ...
          <p className="text-foreground/90">QUANT bridges quantum-safe cryptography with scalable blockchain utility, providing a compliant yet private infrastructure for financial institutions, enterprises, and decentralized ecosystems.</p>
        </section>
